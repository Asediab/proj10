...
insert into public.usr (id, email, name, password, surname) values (1, 'ocr.proj7@yandex.ru', 'User', '$2a$10$a3w89n.b/aRcUYPwdPlO8.89WhanqcUYmDssnr0BgIQ98cK9bxN0q', 'User');
